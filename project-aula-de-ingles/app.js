const vocabulary = [
    ...
    { word: "shift", translation: "remover primeiro", category: "Array Methods" },
    { word: "unshift", translation: "adicionar primeiro", category: "Array Methods" },
    ...
    // Segurança
    { word: "authentication", translation: "autenticação", category: "Security" },
...
vocabulary.forEach(item => {
    ...
    card.innerHTML = `
        ...
        <div class="answer-section">
            <input type="text" class="answer-input" placeholder="Digite a tradução...">
